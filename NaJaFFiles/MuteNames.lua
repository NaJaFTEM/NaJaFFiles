...
if DevAli:get(NaJaF.."Ali:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAli:sadd(NaJaF.."Ali:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevAli:get(NaJaF.."Ali:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
NaJaFName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if NaJaFName then 
NaJaFNames = DevAli:smembers(NaJaF.."Ali:Mute:Names"..msg.chat_id_) or ""
if NaJaFNames and NaJaFNames[1] then 
for i=1,#NaJaFNames do 
if NaJaFName:match("(.*)("..NaJaFNames[i]..")(.*)") then 
...
DevAli:set(NaJaF.."Ali:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAli:del(NaJaF.."Ali:Lock:MuteNames"..msg.chat_id_)
end
end
end
