...
if result.id_ then 
local Alli = DevAli:get("NaJaFTEAM:Photo"..result.id_)
if not result.profile_photo_ then 
if Alli then 
Dev_Ali(msg.chat_id_, msg.id_, 1, "حذف كل صوره مضروب بوري، 😹💔", 1, 'html')
DevAli:del("NaJaFTEAM:Photo"..result.id_) 
end
end
...
DevAli:set("NaJaFTEAM:Photo"..result.id_, result.profile_photo_.big_.persistent_id_) 
end
end
end,nil) 
end
